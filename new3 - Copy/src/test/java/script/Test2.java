...
public class Test2 {
	...
	private static ThreadLocal<WebDriver> threadLocalDriver = new ThreadLocal<>();
	 private static final String CONFIG_PATH = ".\\src\\test\\resources\\brand_template_config2.json";
    ...
    public List<GameData> getGameDataFromExcelTest2() 
    {
    	...
    	if (threadLocalGameData.get() == null) {
    		threadLocalGameData.set(getGameDataFromExcel(".\\src\\test\\resources\\TemplatesFile2.xlsx"));  // Load data from Excel
    	}
    ...
    public void addGamesToLobbies() throws InterruptedException {
        ...
        try {
            ...
            ExcelSummaryWriter.writeSummary(
            		"Game_Addition_Summary__Test_2" +getTimeStamp() + ".xlsx",
