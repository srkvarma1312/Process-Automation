...
//		ZoomUtil.zoomOutUsingKeys(driver);
//		ZoomUtil.scalePage(driver, 0.7);
//		ZoomUtil.scaleMainContainer(driver);
//		ZoomUtil.chromeZoomOut(driver,80);
//		ZoomUtil.zoomOutHard(driver, "80%");
//		ZoomUtil.scaleMainContainer(driver);
