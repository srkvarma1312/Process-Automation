...
public class Mobile {
	...
	private static ThreadLocal<WebDriver> threadLocalDriver = new ThreadLocal<>();
	 private static final String CONFIG_PATH = ".\\src\\test\\resources\\MobileTemplates.json";
    static Logger log = LogManager.getLogger(Mobile.class);
    ...
    public List<GameData> getGameDataFromExcelTest2() 
    {
    	
    	if (threadLocalGameData.get() == null) {
    		threadLocalGameData.set(getGameDataFromExcel(".\\src\\test\\resources\\Mobile.xlsx"));  // Load data from Excel
    	}
    ...
    public void addGamesToLobbies() throws InterruptedException {
    	...
    	List<GameData> gameDataFromExcel =  getGameDataFromExcelTest2();
        ...
        try {
            ...
            ExcelSummaryWriter.writeSummary(
            		"Game_Addition_Summary__Mobile" +getTimeStamp() + ".xlsx",
